...
<head>
    ...
    <title><?= $title; ?> | Data Klasifikasi Makhluk Hidup</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('kingdom'); ?>">Data Kingdom</a>
                        <a class="collapse-item" href="<?= base_url('filum'); ?>">Data Filum</a>
                        <a class="collapse-item" href="<?= base_url('kelas'); ?>">Data Kelas</a>
                        <a class="collapse-item" href="<?= base_url('ordo'); ?>">Data Ordo</a>
                        <a class="collapse-item" href="<?= base_url('famili'); ?>">Data Famili</a>
                        <a class="collapse-item" href="<?= base_url('hewan'); ?>">Data Hewan</a>
                        <a class="collapse-item" href="<?= base_url('tumbuhan'); ?>">Data Tumbuhan</a>
                        <a class="collapse-item" href="<?= base_url('fungi'); ?>">Data Fungi</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed " href="#" data-toggle="collapse" data-target="#collapseMaster" aria-expanded="true" aria-controls="collapseMaster">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Makhluk Hidup</span>
                </a>
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Master Makhluk Hidup:</h6>
                        <a class="collapse-item" href="<?= base_url('hewan'); ?>">Data Hewan</a>
                        <a class="collapse-item" href="<?= base_url('tumbuhan'); ?>">Data Tumbuhan</a>
                        <a class="collapse-item" href="<?= base_url('fungi'); ?>">Data Fungi</a>
                    </div>
