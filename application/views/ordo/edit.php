        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                        ...
                        <div class="input-group">
                            <select name="kode_kelas" id="kode_kelas" class="custom-select cari_kelas">
                                ...
                                <?php foreach ($kelas as $kd) : ?>
                                    <option <?= set_select('kode_kelas', $kd['kode_kelas']) ?> value="<?= $kd['kode_kelas'] ?>"><?= $kd['nama_kelas'] ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_ordo', $ordo['nama_ordo']); ?>" name="nama_ordo" id="nama_ordo" type="text" class="form-control" placeholder="Nama ordo...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('ket_ordo', $ordo['ket_ordo']); ?>" name="ket_ordo" id="ket_ordo" type="text" class="form-control" placeholder="Keterangan ordo...">
